...
/**
 * this is the class that just like or operator but it will have
 ...
 *
 */
public class MultiOrOperator extends MultipleExpression{
	 ...
	 */
	public MultiOrOperator(List<Expression> childlist) {
		super(childlist);
	}

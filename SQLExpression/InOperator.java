...
/**
 * this is the class for an binary operators to handle a parenthesis.
 * @author messfish
 *
 */
public class InOperator extends BinaryExpression{
	 ...
	 */
	public InOperator(Expression left, Expression right){
		super(left, right);
	}

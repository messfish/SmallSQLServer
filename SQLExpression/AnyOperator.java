...
/**
 * this is the class for an binary operators to handle an any command.
 * @author messfish
 *
 */
public class AnyOperator extends UnaryExpression{
	 ...
	 */
	public AnyOperator(Expression child){
		super(child);
	}

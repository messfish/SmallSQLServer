...
/**
 * this is the class for an unary operators to handle an exist command.
 * @author messfish
 *
 */
public class ExistsOperator extends UnaryExpression{
	 ...
	 */
	public ExistsOperator(Expression child){
		super(child);
	}

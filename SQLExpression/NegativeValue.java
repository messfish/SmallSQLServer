...
/**
 * this is the class for an unary operators to handle a negative operator.
 * Note that I use an "~" to distinguish the "-" which is minus operator.
 * @author messfish
 *
 */
public class NegativeValue extends UnaryExpression{
	 ...
	 */
	public NegativeValue(Expression child){
		super(child);
	}

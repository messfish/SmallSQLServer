...
/**
 * this is the class for an unary operators to handle an all command.
 * @author messfish
 *
 */
public class AllOperator extends UnaryExpression{
	 ...
	 */
	public AllOperator(Expression child){
		super(child);
	}
